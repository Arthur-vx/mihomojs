...
// 规则
const rules = [
  // Steam 内置 Chromium 的禁用占位域名，快速失败避免走漏网代理超时。
  "DOMAIN,disabled.invalid,REJECT",
  // Steam 下载/国区优先走国内直连规则，客户端登录/API/商店/社区走 Steam 代理组。
  "RULE-SET,gamedl,游戏下载",
  "DOMAIN-SUFFIX,content.steamchina.com,游戏下载",
  "DOMAIN-SUFFIX,steamcontent.tnkjmec.com,游戏下载",
  "DOMAIN-SUFFIX,dl.steam.clngaa.com,游戏下载",
  "DOMAIN-SUFFIX,dl.steam.ksyna.com,游戏下载",
  "DOMAIN-SUFFIX,st.dl.bscstorage.net,游戏下载",
  "DOMAIN-SUFFIX,st.dl.eccdnx.com,游戏下载",
  "DOMAIN-SUFFIX,st.dl.pinyuncloud.com,游戏下载",
  ...
  "DOMAIN,clientconfig.akamai.steamstatic.com,Steam",
